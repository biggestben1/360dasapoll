...
Route::get('/question/{id}-{slug}', 'QuestionController@destroyanswer');
Route::post('/questionnaires', 'QuestionnaireController@store');

Route::get('/surveys/{questionnaire}-{slug}', 'SurveyController@show')->name('show');
Route::post('/surveys/{questionnaire}-{slug}', 'SurveyController@store')->name('store');